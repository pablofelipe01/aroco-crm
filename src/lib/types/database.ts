    ...
    Tables: {
      ...
      ventas_operaciones: {
        Row: {
          ...
          cliente: string | null;
          odc: string;
          remision_aroco: string | null;
          recepcion: string | null;
          origen: string | null;
          peso_remision_kg: number;
          aroco_kg: number;
          recepcion_kg: number;
          valor_kilo_negociado: number;
          valor_total: number;
          valor_bonificacion: number;
          valor_a_pagar: number;
          precio_base_proveedor: number;
          pago_base: number;
          descuento_humedad: number;
          bonificacion_proveedor: number;
          retenciones: number;
          pago_proveedor: number;
          a_favor_aroco: number;
          comision_flete: number;
          comision_sostenible: number;
          disponible_aroco: number;
          costo_transporte_seleccion: number;
          utilidad: number;
          venta_60: number;
          compra_40: number;
          costo_real_kg: number | null;
...
export type VentaOperacion = Tables<"ventas_operaciones">;
