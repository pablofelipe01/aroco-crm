...
const SECCIONES: { titulo: string; campos: [keyof Proveedor, string][] }[] = [
  {
    ...
    campos: [
      ...
      ["documento_representante", "Documento del representante / persona natural"],
    ],
  },
  {
    titulo: "Ubicación",
  ...
  },
  {
    ...
    campos: [
      ...
      ["capacidad_comercializacion", "Capacidad de comercialización"],
      ["municipios_produccion", "Municipios de producción"],
  ...
  },
  {
    ...
    campos: [
      ...
      ["tipo_documento_titular", "Tipo doc. titular"],
      ["cedula_titular", "Documento titular"],
  ...
  },
  {
    ...
    campos: [
      ...
      ["declara_origen_licito", "Declara origen lícito (SARLAFT)"],
      ["autoriza_verificacion", "Autoriza verificación"],
    ],
  },
];
